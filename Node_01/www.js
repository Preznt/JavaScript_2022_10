 ...
 */
// body에 담긴 post 데이터를 잘 꺼내서 쓸 수 있도록 만들어라
 ...
 * 암호화 등을 전혀 수행할 수 없다
 *
 * 그래서 GET 는 주로 데이터를 서버에 요청할떄 사용한다
 */
...
/**
 * form 에서 입력한 데이터를 POST method로 받기
 * form 에서 입력한 데이터를 POST로 보내면
 ...
 *    파일 업로드 등을 할때는 반드시 POST로 전송해야 한다
 */
